...
steps:
  ...
  seasonal-allergic-and-chronic-rhinitis---primary:
    run: seasonal-allergic-and-chronic-rhinitis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  other-allergic-and-chronic-rhinitis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: seasonal-allergic-and-chronic-rhinitis---primary/output
